    ...
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-lg border border-slate-100">
        <div className="text-center">
          <div className="inline-flex bg-emerald-100 p-3 rounded-2xl text-emerald-700 mb-3">
            <Tractor className="h-10 w-10" />
          </div>
          <h2 className="text-2xl font-bold text-slate-900">Farmer Login</h2>
          <p className="mt-1 text-sm text-slate-500">Access equipment rental marketplace</p>
        </div>
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="mt-4 p-3 bg-amber-50 rounded-lg border border-amber-200 text-xs text-amber-800">
            ...
            <br />
            Phone: <code className="font-mono">9123456789</code> | Password: <code className="font-mono">password123</code>
          </div>

          <div className="text-center mt-4">
            <span className="text-xs text-slate-500">Don't have a farmer account? </span>
